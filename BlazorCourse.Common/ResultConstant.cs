...
namespace BlazorCourse.Common
{
    public class ResultConstant
    {
        ...
        public const string Admin_Email = "irem@gmail.com";
        ...
        //-----------------------------------------------------------------------------------------//
        public const string BaseApiUrl = "https://localhost:44349/";
        public const string ImageServerUrl = "http://localhost:12802/";
        //-----------------------------------------------------------------------------------------//
